...
return [
   ...
   "System Name" => "Meet Local",
   "Log In" => "Log In",
   "meta_description" => "Easy And Fast Meet Local",
   "Meta Keyword" => "Hire Guide,Fast Trip",
   ...
   "List" => "List",
   "Id" => "Id",
   "Doctor Name" => "Guide Name",
   "Patient Name" => "Tourist Name",
   "DateTime" => "DateTime",
   "Phone" => "Phone",
   "User Description" => "User Description",
   "Status" => "Status",
   "Add Doctor" => "Add Guide",
   "Image" => "Image",
   "Name" => "Name",
   "Service" => "Service",
   "Action" => "Action",
   ...
   "Review" => "Review",
   "save" => "Save",
   "Enter Doctor Name" => "Enter Guide Name",
   ...
   "About Us" => "About Us",
   "Enter About Doctor" => "Enter About Guide",
   "Services" => "Services",
   ...
   "Submit" => "Submit",
   "Save Doctors Schedule" => "Save Guide Schedule",
   "Add Time" => "Add Time",
   ...
   "Doctor Add Successfully" => "Guide Add Successfully",
   "Doctor Update Successfully" => "Guide Update Successfully",
   ...
   "Total Doctors" => "Total Guides",
   "Total Patients" => "Total Tourists",
   ...
   "Doctor Delete Successfully" => "Guide Delete Successfully",
   ...
   "Search Best Online Doctors" => "Search Best Online Guides",
   "View Doctor Profile" => "View Guide Profile",
   "Get Instant Doctor Appoinment" => "Get Instant Guide Appoinment",
   "Submit now" => "Submit now",
   "Logout" => "Logout",
   "Sign in" => "Sign in",
   "Specialist" => "Specialist",
   "Join As Doctor" => "Join As Guide",
   ...
   "Search Doctors" => "Search Guides",
   "Showing" => "Showing",
   "Results" => "Results",
   "Specialist by" => "Specialist by",
   "Visit Now" => "Visit Now",
   "Doctor Details" => "Guide Details",
   ...
   "Login Now" => "Login Now",
   "Favourite Doctors" => "Favourite Guides",
   ...
   "Favourite" => "Favourite",
   "Book Now" => "Book Now",
   "No any doctors In your Favorite list" => "No any guides In your Favorite list",
   "Save Change" => "Save Change",
   "Cancel" => "Cancel",
   "Patient Dashboard" => "Patient Dashboard",
   "Total" => "Total",
   "Pending" => "Pending",
   "Doctors Appointment" => "Guides Appointment",
   "past" => "Past",
   "Today" => "Today",
   "Upcoming" => "Upcoming",
   "Date" => "Date",
   ...
   "Accept" => "Accept",
   "Complete" => "Complete",
   "Doctor Dashboard" => "Guide Dashboard",
   "Total Appointment" => "Total Appointment",
   "Total Review" => "Total Review",
   "New Appointments" => "New Appointments",
   "Patients Appointments" => "Tourists Appointments",
   ...
   "Saturday" => "Saturday",
   "Sunday" => "Sunday",
   "Doctor Login" => "Guide Login",
   "Not a Doctor" => "Guide Register",
   "Login" => "Login",
   "Doctor Register" => "Guide Register",
   "Already a Doctor" => "Already a Guide?",
   "Doctor Reviews" => "Guide Reviews",
   "No Any Review List Get" => "No Any Review List Get",
   ...
   "Doctor remove in Favorite list" => "Guide remove in Favorite list",
   "Doctor add in Favorite list" => "Guide add in Favorite list",
   "Please" => "Please",
   ...
   "You Need To Approve Doctors Profile" => "You Need To Approve Guides Profile ",
   "Is RTL" => "Is RTL",
   ...
   "Doctor isnot Avilable" => "Guide isn't Avilable",
   "Refund" => "Refund",
