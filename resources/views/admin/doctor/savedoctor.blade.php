      ...
      <div class="container-fluid">
         ...
         <div class="row" style="display: flex;justify-content: center;">
                              ...
                              <div class="form-group">
                                 <div class="mar20">
                                    <div id="uploaded_images">
                                       ...
                                       <div class="upload-btn-wrapper">
                                          <button type="button" class="btn imgcatlog">
                                             <input type="hidden" name="real_images[]" value="{{ $image }}" />
                                             <img src="{{ asset('public/upload/doctors/' . $image) }}" alt="..."
                                                class="img-thumbnail imgsize" id="preview-image-{{ $index }}" />
                                          </button>
                                       ...
                                       @for ($i = count(json_decode($data->images, true) ?? []); $i < 4; $i++) <div
                                          class="upload-btn-wrapper">
                                          <button type="button" class="btn imgcatlog">
                                             <input type="hidden" name="real_images[]" value="" />
                                             <img src="{{ asset('public/upload/profile/profile.png') }}" alt="..."
                                                class="img-thumbnail imgsize" id="preview-image-{{ $i }}" />
                                          </button>
                                          <input type="file" name="upload_images[]"
            ...
            <div class="col-md-12 p-0" id="addressorder">
               ...
               <input type="text" id="us2-address" name="address" placeholder='{{__("message.Search Location")}}'
...
<script>
   function previewImage(input, previewId) {
      ...
      if (file) {
         ...
         preview.attr('src', '{{ asset('public / upload / profile / profile.png') }}');
      }
   }
</script>
@stop
