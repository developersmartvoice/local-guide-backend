...
<head>
   ...
   @if(__("message.RTL")==0)
   <link href="{{asset('public/admin_design/layouts/vertical/assets/css/app-rtl.min.css')}}" id="app-style"
      rel="stylesheet" type="text/css" />
   @else
   <link href="{{asset('public/admin_design/layouts/vertical/assets/css/app.min.css')}}" id="app-style" rel="stylesheet"
      type="text/css" />
   @endif
   <link
   ...
   <script type="text/javascript"
      src='https://maps.google.com/maps/api/js?key={{Config::get("mapdetail.key")}}&libraries=places'></script>
</head>
...
<body>
               ...
               <div class="dropdown d-inline-block">
                  <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                     ...
                     <img class="rounded-circle header-profile-user"
                        src="{{asset('public/upload/profile/').'/'.Sentinel::getUser()->profile_pic}}"
                        alt="Header Avatar" />
                     <span
                        class="d-none d-xl-inline-block ml-1 font-weight-medium font-size-15">{{Session::get("username")}}</span>
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <div class="text-sm-right d-none d-sm-block">
                     <i class="mdi mdi-heart text-danger"></i> {{__("message.by")}} <a href="https://themesbrand.com/"
                        target="_blank" class="text-reset">{{__("message.System Name")}}</a>
                  </div>
               </div>
            </div>
         </div>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/waypoints/lib/jquery.waypoints.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/jquery.counterup/jquery.counterup.min.js')}}"></script>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net/js/jquery.dataTables.min.js')}}"></script>
   <script src="https://cdn.jsdelivr.net/bootstrap.tagsinput/0.8.0/bootstrap-tagsinput.min.js"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-buttons/js/dataTables.buttons.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')}}"></script>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-buttons/js/buttons.html5.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-buttons/js/buttons.print.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-buttons/js/buttons.colVis.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js')}}"></script>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/js/pages/ecommerce-add-product.init.js')}}"></script>
   ...
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js')}}"></script>
   <script
      src="{{asset('public/admin_design/layouts/vertical/assets/libs/twitter-bootstrap-wizard/prettify.js')}}"></script>
