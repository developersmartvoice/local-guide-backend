                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                                                     <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif;">{{$user->name}}<br></p>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td align="right" class="es-infoblock esd-block-text es-m-txt-c">
                                                                     <p><a href="{{url('/')}}" class="view" target="_blank" style="font-family: 'arial', 'helvetica neue', 'helvetica', 'sans-serif';">{{__('message.Log In')}}</a></p>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td class="esd-block-text es-m-txt-c" align="left">
                                                                     <h1 style="color: #ffffff; line-height: 100%;">{{__('message.System Name')}}</h1>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  <td class="esd-block-text es-p15b" align="center">
                                                                     <h2 style="color: #333333; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;">{{$user->msg}}</h2>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
