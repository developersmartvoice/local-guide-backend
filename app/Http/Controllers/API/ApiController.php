           ...
           $rules = [
            ...
            if ($validator->fails()) {
                  ...
                  $response['msg'] = $message;
                     ...
                     $data=Doctors::Where('address', 'like', '%' . $request->get("term") . '%')->select("id","name","address","image","department_id")->paginate(10);
                     if($data){
         ...
         if ($validator->fails()) {
               ...
               $response['msg'] = $message;
                   ...
                   $data=DB::table("doctors")
                       ->select("doctors.id","doctors.name","doctors.address","doctors.department_id","doctors.image","doctors.consultation_fees","doctors.aboutus"
