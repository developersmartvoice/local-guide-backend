                    ...
                    <h4 class="card-title">
                        <?php if(Request::get('data_filter') ): ?>
                            <?php if($total == null): ?>
                                User not found
                                <?php else: ?>
                                Total user register are <?php echo e($total); ?>
                      ...
                      <table id="myTable" class="table table-bordered dt-responsive tablels">
                         ...
                         <tbody>
                            <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local-guide-backend\resources\views/admin/report/user.blade.php ENDPATH**/ ?>