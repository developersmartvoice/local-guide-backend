    ...
    <div class="card-actions flex justify-space-between">
      ...
      <div class="flex-end">
         <div id="braintree_pay" class="payfrom">
                          ...
                          <form method="post" id="payment-form" action="<?php echo e(route('save-braintree')); ?>">
                            <?php echo e(csrf_field()); ?>  
                              <section>
                                 <input id="book_appointment_id" name="id" type="hidden" value="<?php echo e($data->id); ?>">
                                <input id="amount" name="amount" type="hidden" value="<?php echo e(number_format($amount,2,'.','')); ?>">
                                  <div class="bt-drop-in-wrapper">
                                    <div id="bt-dropin"></div>
                                  </div>
                              </section>
                              <input id="nonce" name="payment_method_nonce" type="hidden" />
                              <button class="btn btn-primary" type="submit"><span><?php echo e(__("message.Pay")); ?></span></button>
                          </form>
...
<script>
  ...
  <script src="https://js.braintreegateway.com/web/dropin/1.23.0/js/dropin.min.js"></script>
    <script>
        ...
        var client_token = "<?php echo e($braintree_token); ?>";
...
</html><?php /**PATH C:\xampp\htdocs\local-guide-backend\resources\views/braintree.blade.php ENDPATH**/ ?>