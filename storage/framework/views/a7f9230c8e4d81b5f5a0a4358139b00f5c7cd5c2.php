                  ...
                  <div class="card-body">
                     <form action="<?php echo e(url('admin/updatedoctor')); ?>" class="needs-validation" method="post"
                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control"
                                    placeholder='<?php echo e(__("message.Enter Doctor Name")); ?>' id="name" name="name" required=""
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="genderNone"
                                       value="none" <?php echo e(isset($data->gender) && $data->gender == 'none' ? 'checked' : ''); ?>>
                                 ...
                                 <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="genderMale"
                                       value="male" <?php echo e(isset($data->gender) && $data->gender == 'male' ? 'checked' : ''); ?>>
                                 ...
                                 <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="genderFemale"
                                       value="female" <?php echo e(isset($data->gender) && $data->gender == 'female' ? 'checked' :
                                    ''); ?>>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 <label for="facebook_url"><?php echo e(__("message.Facebook Url")); ?><span
                                       class="reqfield">*</span></label>
                              ...
                              <div class="form-group">
                                 <label for="twitter_url"><?php echo e(__("message.Twitter Url")); ?><span
                                       class="reqfield">*</span></label>
                        ...
                        <div class="col-md-12 p-0" id="addressorder">
                           ...
                           <input type="text" id="us2-address" name="address"
                              placeholder='<?php echo e(__("message.Search Location")); ?>' required data-parsley-required="true"
                              required="" />
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\local-guide-backend\resources\views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>