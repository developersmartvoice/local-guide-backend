                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td class="es-infoblock esd-block-text es-m-txt-c" align="left">
                                                                     <p style="font-family: arial, helvetica\ neue, helvetica, sans-serif;"><?php echo e($user->name); ?><br></p>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td align="right" class="es-infoblock esd-block-text es-m-txt-c">
                                                                     <p><a href="<?php echo e(url('/')); ?>" class="view" target="_blank" style="font-family: 'arial', 'helvetica neue', 'helvetica', 'sans-serif';"><?php echo e(__('message.Log In')); ?></a></p>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  <td class="esd-block-text es-m-txt-c" align="left">
                                                                     <h1 style="color: #ffffff; line-height: 100%;"><?php echo e(__('message.System Name')); ?></h1>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
                                                   ...
                                                   <tr>
                                                      <td class="esd-container-frame" width="530" valign="top" align="center">
                                                         <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                               <tr>
                                                                  <td class="esd-block-image es-p20t es-p25b es-p35r es-p35l" align="center" style="font-size:0"><a target="_blank" href="#"><img src="https://tlr.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/83001522239333914.png" alt="ship" style="display: block;" title="ship" width="150"></a></td>
                                                               </tr>
                                                               <tr>
                                                                  <td class="esd-block-text es-p15b" align="center">
                                                                     <h2 style="color: #333333; font-family: 'open sans', 'helvetica neue', helvetica, arial, sans-serif;"><?php echo e($user->msg); ?></h2>
                                                                  </td>
                                                               </tr>
                                                            </tbody>
                                                         </table>
...
</html><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/email/Ordermsg.blade.php ENDPATH**/ ?>