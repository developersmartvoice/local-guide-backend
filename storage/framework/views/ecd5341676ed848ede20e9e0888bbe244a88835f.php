          ...
          <div class="row">
             <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                   <h4 class="mb-0">Doctors Report</h4>
                   <div class="page-title-right">
                      <ol class="breadcrumb m-0">
                         <li class="breadcrumb-item active">Doctors Report</li>
                      </ol>
                   </div>
                </div>
             </div>
                                ...
                                <div class="row">
                                        <div class="col-3">
                                                <div class="input-group">
                                                        ...
                                                        <select name="data_filter" id="data_filter" class="form-control" onchange="showDiv('hidden_div', this)">
                    ...
                    <h4 class="card-title">
                        <?php if(Request::get('data_filter') ): ?>
                            <?php if($total == null): ?>
                                Doctor not found
                                <?php else: ?>
                                Total doctor register are <?php echo e($total); ?>

                            <?php endif; ?>
                            <?php else: ?>
                            <?php echo e(__("message.Doctors")); ?> <?php echo e(__("message.List")); ?>
                      ...
                      <table id="myTable" class="table table-bordered dt-responsive tablels">
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img src="<?php echo e(asset('public/upload/doctors/')); ?>/<?php echo e($doc->image); ?>" alt="" width="100px;"> </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/admin/report/doctor.blade.php ENDPATH**/ ?>