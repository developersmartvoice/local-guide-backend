...
<?php echo e(__('message.About Us')); ?>
  ...
  <section class="page-title centred bg-color-1">
            ...
            <div class="auto-container">
                <div class="content-box">
                    <div class="title">
                        <h1><?php echo e(__('message.About Us')); ?></h1>
                    </div>
                    <ul class="bread-crumb clearfix">
                        <li><a href="<?php echo e(url('/')); ?>"><?php echo e(__('message.Home')); ?></a></li>
                        <li><?php echo e(__('message.About Us')); ?></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_3">
                            <div class="image-box">
                                ...
                                <figure class="image image-1 paroller"><img src="<?php echo e(asset('public/front_pro/assets/images/resource/about-4.jpg')); ?>" alt=""></figure>
                                <figure class="image image-2 paroller-2"><img src="<?php echo e(asset('public/front_pro/assets/images/resource/about-3.jpg')); ?>" alt=""></figure>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/freakd1c/public_html/demo/bookappointment/resources/views/user/aboutus.blade.php ENDPATH**/ ?>