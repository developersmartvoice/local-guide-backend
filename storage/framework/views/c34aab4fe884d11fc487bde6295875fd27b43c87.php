                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id="facebook_url" name="facebook_url" placeholder='<?php echo e(__("message.Enter Facebook Url")); ?>' value="<?php echo e(isset($data->facebook_url)?$data->facebook_url:''); ?>" required="" >
                              </div>
                              <div class="form-group">
                                 <label for="twitter_url"><?php echo e(__("message.Twitter Url")); ?><span class="reqfield">*</span></label>
                                 <input type="text" class="form-control" id="twitter_url" name="twitter_url" placeholder='<?php echo e(__("message.Enter Twitter Url")); ?>' value="<?php echo e(isset($data->twitter_url)?$data->twitter_url:''); ?>" required="">
                              </div>
                           </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ubnzxmjc/localguide/resources/views/admin/doctor/savedoctor.blade.php ENDPATH**/ ?>