         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-flex align-items-center justify-content-between">
                  <h4 class="mb-0"><?php echo e(__("message.Doctors")); ?></h4>
            ...
            <div class="col-12">
               <div class="card">
                  <div class="card-body">
                     ...
                     <?php endif; ?>
                     <h4 class="card-title"><?php echo e(__("message.Doctors")); ?> <?php echo e(__("message.List")); ?></h4>
                     <p><a class="btn btn-primary" href="<?php echo e(url('admin/savedoctor/0')); ?>"><?php echo e(__("message.Add Doctor")); ?></a></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\local-guide-backend\resources\views/admin/doctor/default.blade.php ENDPATH**/ ?>